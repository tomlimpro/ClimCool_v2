<template>
  <div class="utilisateur-wrapper">
    <h1 id="titre">Professionnel</h1>
    <p style="text-align:center; font-size:25px; font-weight:bolder;">Bureaux Indépendants</p>
...
export default {
    components:{},
    name:'utilisateurs_particuliers'
...
<style scoped>
  ...
  .solution-container {  display: grid;
  grid-template-columns: 1fr 1fr 1fr;
  grid-template-rows: 1fr 1fr 1fr;
  gap: 0px 0px;
  grid-auto-flow: row;
  grid-template-areas:
    "monobloc split split-fix"
    ". . ."
    ". . .";
 }

.monobloc { grid-area: monobloc; }

.split { grid-area: split; }

.split-fix { grid-area: split-fix; }
...
.card-container{  
 ...
 .card-container-2 .card .face{  
   width: 300px;  
   height: 200px;  
   transition: 0.5s;  
 }  
 .card-container-2 .card .face.face1{  
   position: relative;  
   background: #333;  
   display: flex;  
   justify-content: center;  
 ...
 .card-container-2 .card:hover .face.face1{  
   
   transform: translateY(0);  
 }  
 .card-container-2 .card .face.face1 .content{  
   opacity: 0.2;  
   transition: 0.5s;  
 }  
 .card-container-2 .card:hover .face.face1 .content{  
   opacity: 1;  
 }  
 .card-container-2 .card .face.face1 .content img{  
   max-width: 100px;  
 }  
 .card-container-2 .card .face.face1 .content h3{  
   margin: 10px 0 0;  
   padding: 0;  
   color: #fff;  
   text-align: center;  
 ...
 .card-container-2 .card .face.face2{  
   position: relative;  
   background: #fff;  
   display: flex;  
   justify-content: center;  
 ...
 .card-container-2 .card:hover .face.face2{  
   transform: translateY(0);  
 }  
 .card-container-2 .card .face.face2 .content p{  
   margin: 0;  
   padding: 0;  
 }  
 .card-container-2 .card .face.face2 .content a{  
   margin: 15px 0 0;  
   display: inline-block;  
   text-decoration: none;  
   font-weight: 900;  
 ...
 .card-container-2 .card .face.face2 .content a:hover{  
   background: #333;  
   color: #fff;  
 }  
